...
SELECT DISTINIC Rating FROM Movies;
...
RIGHT JOIN MovieTheaters ON Movies.Code = MovieTheaters.Movie
WHERE Movie_theatres.Movie IS NULL;
...
DELETE MovieTheaters WHERE Movie IN (
  SELECT * FROM Movies WHERE Rating = "NC-17"
);
